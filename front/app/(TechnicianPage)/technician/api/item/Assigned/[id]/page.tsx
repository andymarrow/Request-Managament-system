...
export default function AssignedCompleted() {
  ...
  useEffect(() => {
    ...
    if (token) {
      ...
      const assignedIndex = pathSegments.indexOf('Assigned');
  ...
  return (
    <div className="flex items-center  p-4">
      <div className="bg-slate-400  rounded-lg shadow-lg p-4 sm:p-6 lg:p-8  w-full">
        ...
        {!isTechnicianView ? (
          <>
            <h2 className="text-3xl font-bold mb-4 text-center">Assigned & Pending</h2>
            <p className="mb-4">You are Checking a maintainance request for <span className="font-bold">{requestData?.requester_name}</span>'s form</p>
            ...
            <div className="bg-slate-300 rounded-lg p-4">
              <form className="mt-4">
                ...
                <div className="flex items-center justify-center">
                  <p className="text-green-500 font-extrabold text-2xl"> On Going Request</p>
                </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-96">
            <h2 className="text-2xl font-bold mb-4 text-center">Detail of the Problem from Your View</h2>
            <textarea
              className="border rounded-md px-3 py-2 w-full"
